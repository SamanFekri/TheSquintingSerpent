...
def main():
    ...
    ap.set_defaults(bfs=True)
    ap.add_argument("--bfs_space_penalty", type=float, default=0.5)
    ap.add_argument("--bfs_tail_penalty", type=float, default=0.5)
    ap.add_argument("--death_penalty", type=float, default=5.0)
    ...
    env = SnakeEnv.from_map_file(
        ...
        bfs_space_penalty=args.bfs_space_penalty,
        bfs_tail_penalty=args.bfs_tail_penalty,
        ...
        while not done and steps < args.max_steps:
            ...
            if renderer:
                ...
                renderer.set_status([
                    ...
                    f"Rays: {args.num_rays}  BFS: {args.bfs}",
                    f"StartLen: {args.start_len}  Wrap: {args.wrap}",
                ])
                renderer.draw()
